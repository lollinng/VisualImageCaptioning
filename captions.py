...
def visualise_att(image_path,seq,alphas,rev_word_map,smooth=True):
    """
    Visualizes caption with weights at every word.

    Adapted from paper authors' repo: https://github.com/kelvinxu/arctic-captions/blob/master/alpha_visualization.ipynb
    
    :param image_path: path to image that has been captured
    :param seq: caption
...
if __name__ == '__main__':
    ...
    visualise_att(img, seq, alphas, rev_word_map, False)
